...
const Footer = () => {
    ...
    const services = [
        {href: "", text: "Currency Wallet"},
        {href: "", text: "Currency Transaction"},
        {href: "", text: "Bitcoin Investment"},
        {href: "", text: "Token Sale"}
    ]
               ...
               <div className="row g-5">
                   <div className="col-md-6">
                       <h1 className="text-primary mb-4"><img className="img-fluid me-2" src="img/icon-1.png" alt=""
                                                              style={{width: 45 + 'px'}} />CryptoCoin</h1>
                   ...
                   <div className="col-md-6">
                       ...
                       <div className="position-relative">
                           <input className="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text"
                               ...
                               <button type="button"
                                       className="btn btn-primary py-2 px-3 position-absolute top-0 end-0 mt-2 me-2">SignUp
                               </button>
                       </div>
                   </div>
                   ...
                   <div className="col-lg-3 col-md-6">
                       ...
                       {services.map((service) => (
                           <FooterItem herf={service.href} text={service.text}/>
                       ))}
                   ...
                   <div className="col-lg-3 col-md-6">
                       ...
                       {links.map((link) => (
                           <FooterItem herf={link.href} text={link.text}/>
                       ))}
